...
func (m *MockUserRepo) FindAll(_ context.Context, _, _ int) ([]*domain.User, int64, error) {
	args := m.Called()
	return args.Get(0).([]*domain.User), int64(len(args.Get(0).([]*domain.User))), args.Error(1)
}
